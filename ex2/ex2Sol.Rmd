...
The difference to Blundell and Costa Dias comes from the dataset. Original paper used all the observations while the result here restricts to region 1. Also noted is the difficulty of estimation when unobserved correlation exists  between u and v.  
...
> The result shows the ITT effect is insignificant, unlike 6.2, probably because of the crowding out of averaging. Also noted that x has a negative significant coefficient indicating that region 1 is less z score on average.  
